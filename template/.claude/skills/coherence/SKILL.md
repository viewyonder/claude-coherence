---
name: coherence
description: Coherence guardrails system — init wizard, architecture review, drift detection, test runner, hook inspector, spec reporter, config viewer, activity history, and status.
user_invocable: true
